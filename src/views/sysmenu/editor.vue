    ...
    <el-dialog :title="title" :visible.sync="visible">
        <el-form v-if="visible == true" ref="saveForm" label-position="right" :model="entity" :rules="rules" status-icon label-width="120px">
            ...
            <el-form-item :label='$t("menu.parent_code")' prop="parentCode" >
                <el-select style="width: 100%;" v-model.trim="entity.parentCode" :placeholder='$t("gloabl_validate.please_select")+$t("menu.parent_code")'>
            ...
            <el-form-item :label='$t("menu.function")' prop="function">
                <el-select style="width: 100%;" v-model.trim="entity.function" :placeholder='$t("gloabl_validate.please_select")+$t("menu.function")'>
                    <el-option
