...
<script>
  ...
  import { getUser,saveUser,editUser,delUser,getRole,getOrg,resetPassword } from '@/api/sysuser'
  ...
  import { mapGetters } from 'vuex'
      ...
      methods: {
        ...
        getRoles(){
          getRole().then(res => {
            if(res){
              this.selectRoles = res.retObject
            }
          })
        },
        getOrgs(){
