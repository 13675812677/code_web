	...
	import ResourceCarEditor from '@/views/resourcecar/editor'
  	export default {
    	...
    	data() {
				...
				// 定义表格字段
        		header: [
    				{title: this.$t('resourcecar.carDesc'), field: 'carDesc', class: ''},   
    				{title: this.$t('resourcecar.status'), field: 'status', class: ''},   
    				{title: this.$t('resourcecar.carType'), field: 'carType', class: ''},   
